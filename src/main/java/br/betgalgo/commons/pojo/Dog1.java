...
public class Dog1 implements Serializable {
	 ...
	 */
	public Dog1(Integer dogId, String classPreview, String classPreview3, String classPreviewPanel, Double chanceOfWin,
	...
	public Dog1 withDogId(Integer dogId) {
		this.dogId = dogId;
		return this;
	}
	...
	public Dog1 withClassPreview(String classPreview) {
		this.classPreview = classPreview;
		return this;
	}
	...
	public Dog1 withClassPreview3(String classPreview3) {
		this.classPreview3 = classPreview3;
		return this;
	}
	...
	public Dog1 withClassPreviewPanel(String classPreviewPanel) {
		this.classPreviewPanel = classPreviewPanel;
		return this;
	}
	...
	public Dog1 withChanceOfWin(Double chanceOfWin) {
		this.chanceOfWin = chanceOfWin;
		return this;
	}
	...
	public Dog1 withBestRecordTime(Double bestRecordTime) {
		this.bestRecordTime = bestRecordTime;
		return this;
	}
	...
	public Dog1 withTopSpeed(Integer topSpeed) {
		this.topSpeed = topSpeed;
		return this;
	}
	...
	public Dog1 withTrapNumber(Integer trapNumber) {
		this.trapNumber = trapNumber;
		return this;
	}
	...
	public Dog1 withRaceId(Integer raceId) {
		this.raceId = raceId;
		return this;
	}
	...
	public Dog1 withRaceDate(String raceDate) {
		this.raceDate = raceDate;
		return this;
	}
	...
	public Dog1 withName(String name) {
		this.name = name;
		return this;
	}
	...
	public Dog1 withColor(String color) {
		this.color = color;
		return this;
	}
	...
	public Dog1 withSex(String sex) {
		this.sex = sex;
		return this;
	}
	...
	public Dog1 withBirth(String birth) {
		this.birth = birth;
		return this;
	}
	...
	public Dog1 withWeight(Double weight) {
		this.weight = weight;
		return this;
	}
	...
	public Dog1 withTrainerName(String trainerName) {
		this.trainerName = trainerName;
		return this;
	}
	...
	public Dog1 withLastRaceDate(Integer lastRaceDate) {
		this.lastRaceDate = lastRaceDate;
		return this;
	}
	...
	public Dog1 withAnalysis(Analysis analysis) {
		this.analysis = analysis;
		return this;
	}
	...
	public Dog1 withAnalysis2(Analysis2 analysis2) {
		this.analysis2 = analysis2;
		return this;
	}
	...
	public Dog1 withHistoryRaces(List<HistoryRace> historyRaces) {
		this.historyRaces = historyRaces;
		return this;
	}
