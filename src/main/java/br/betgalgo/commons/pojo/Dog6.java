...
public class Dog6 implements Serializable {
	 ...
	 */
	public Dog6(Integer dogId, String classPreview, String classPreview3, String classPreviewPanel, Double chanceOfWin,
	...
	public Dog6 withDogId(Integer dogId) {
		this.dogId = dogId;
		return this;
	}
	...
	public Dog6 withClassPreview(String classPreview) {
		this.classPreview = classPreview;
		return this;
	}
	...
	public Dog6 withClassPreview3(String classPreview3) {
		this.classPreview3 = classPreview3;
		return this;
	}
	...
	public Dog6 withClassPreviewPanel(String classPreviewPanel) {
		this.classPreviewPanel = classPreviewPanel;
		return this;
	}
	...
	public Dog6 withChanceOfWin(Double chanceOfWin) {
		this.chanceOfWin = chanceOfWin;
		return this;
	}
	...
	public Dog6 withBestRecordTime(Double bestRecordTime) {
		this.bestRecordTime = bestRecordTime;
		return this;
	}
	...
	public Dog6 withTopSpeed(Integer topSpeed) {
		this.topSpeed = topSpeed;
		return this;
	}
	...
	public Dog6 withTrapNumber(Integer trapNumber) {
		this.trapNumber = trapNumber;
		return this;
	}
	...
	public Dog6 withRaceId(Integer raceId) {
		this.raceId = raceId;
		return this;
	}
	...
	public Dog6 withRaceDate(String raceDate) {
		this.raceDate = raceDate;
		return this;
	}
	...
	public Dog6 withName(String name) {
		this.name = name;
		return this;
	}
	...
	public Dog6 withColor(String color) {
		this.color = color;
		return this;
	}
	...
	public Dog6 withSex(String sex) {
		this.sex = sex;
		return this;
	}
	...
	public Dog6 withBirth(String birth) {
		this.birth = birth;
		return this;
	}
	...
	public Dog6 withWeight(Double weight) {
		this.weight = weight;
		return this;
	}
	...
	public Dog6 withTrainerName(String trainerName) {
		this.trainerName = trainerName;
		return this;
	}
	...
	public Dog6 withLastRaceDate(Integer lastRaceDate) {
		this.lastRaceDate = lastRaceDate;
		return this;
	}
	...
	public Dog6 withAnalysis(Analysis analysis) {
		this.analysis = analysis;
		return this;
	}
	...
	public Dog6 withAnalysis2(Analysis2 analysis2) {
		this.analysis2 = analysis2;
		return this;
	}
	...
	public Dog6 withHistoryRaces(List<HistoryRace> historyRaces) {
		this.historyRaces = historyRaces;
		return this;
	}
