...
public class Dog4 implements Serializable {
	 ...
	 */
	public Dog4(Integer dogId, String classPreview, String classPreview3, String classPreviewPanel, Double chanceOfWin,
	...
	public Dog4 withDogId(Integer dogId) {
		this.dogId = dogId;
		return this;
	}
	...
	public Dog4 withClassPreview(String classPreview) {
		this.classPreview = classPreview;
		return this;
	}
	...
	public Dog4 withClassPreview3(String classPreview3) {
		this.classPreview3 = classPreview3;
		return this;
	}
	...
	public Dog4 withClassPreviewPanel(String classPreviewPanel) {
		this.classPreviewPanel = classPreviewPanel;
		return this;
	}
	...
	public Dog4 withChanceOfWin(Double chanceOfWin) {
		this.chanceOfWin = chanceOfWin;
		return this;
	}
	...
	public Dog4 withBestRecordTime(Double bestRecordTime) {
		this.bestRecordTime = bestRecordTime;
		return this;
	}
	...
	public Dog4 withTopSpeed(Integer topSpeed) {
		this.topSpeed = topSpeed;
		return this;
	}
	...
	public Dog4 withTrapNumber(Integer trapNumber) {
		this.trapNumber = trapNumber;
		return this;
	}
	...
	public Dog4 withRaceId(Integer raceId) {
		this.raceId = raceId;
		return this;
	}
	...
	public Dog4 withRaceDate(String raceDate) {
		this.raceDate = raceDate;
		return this;
	}
	...
	public Dog4 withName(String name) {
		this.name = name;
		return this;
	}
	...
	public Dog4 withColor(String color) {
		this.color = color;
		return this;
	}
	...
	public Dog4 withSex(String sex) {
		this.sex = sex;
		return this;
	}
	...
	public Dog4 withBirth(String birth) {
		this.birth = birth;
		return this;
	}
	...
	public Dog4 withWeight(Double weight) {
		this.weight = weight;
		return this;
	}
	...
	public Dog4 withTrainerName(String trainerName) {
		this.trainerName = trainerName;
		return this;
	}
	...
	public Dog4 withLastRaceDate(Integer lastRaceDate) {
		this.lastRaceDate = lastRaceDate;
		return this;
	}
	...
	public Dog4 withAnalysis(Analysis analysis) {
		this.analysis = analysis;
		return this;
	}
	...
	public Dog4 withAnalysis2(Analysis2 analysis2) {
		this.analysis2 = analysis2;
		return this;
	}
	...
	public Dog4 withHistoryRaces(List<HistoryRace> historyRaces) {
		this.historyRaces = historyRaces;
		return this;
	}
