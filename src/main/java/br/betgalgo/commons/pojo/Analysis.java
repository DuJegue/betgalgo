...
public class Analysis implements Serializable {
	...
	private final static long serialVersionUID = -1395126720776793450L;
	...
	public Analysis withTopTime(Double topTime) {
		this.topTime = topTime;
		return this;
	}
	...
	public Analysis withOverall(Integer overall) {
		this.overall = overall;
		return this;
	}
	...
	public Analysis withPreview(Integer preview) {
		this.preview = preview;
		return this;
	}
	...
	public Analysis withResult(String result) {
		this.result = result;
		return this;
	}
	...
	public Analysis withRatingTopTime(Integer ratingTopTime) {
		this.ratingTopTime = ratingTopTime;
		return this;
	}
	...
	public Analysis withAveragePlace(Double averagePlace) {
		this.averagePlace = averagePlace;
		return this;
	}
	...
	public Analysis withRatingAveragePlace(Integer ratingAveragePlace) {
		this.ratingAveragePlace = ratingAveragePlace;
		return this;
	}
	...
	public Analysis withLastTime(Double lastTime) {
		this.lastTime = lastTime;
		return this;
	}
	...
	public Analysis withRatingLastTime(Integer ratingLastTime) {
		this.ratingLastTime = ratingLastTime;
		return this;
	}
	...
	public Analysis withAverageTime(Double averageTime) {
		this.averageTime = averageTime;
		return this;
	}
	...
	public Analysis withRatingAverageTime(Integer ratingAverageTime) {
		this.ratingAverageTime = ratingAverageTime;
		return this;
	}
	...
	public Analysis withTopBreakTime(Double topBreakTime) {
		this.topBreakTime = topBreakTime;
		return this;
	}
	...
	public Analysis withRatingTopBreakTime(Integer ratingTopBreakTime) {
		this.ratingTopBreakTime = ratingTopBreakTime;
		return this;
	}
	...
	public Analysis withAverageBreakTime(Double averageBreakTime) {
		this.averageBreakTime = averageBreakTime;
		return this;
	}
	...
	public Analysis withRatingAverageBreakTime(Integer ratingAverageBreakTime) {
		this.ratingAverageBreakTime = ratingAverageBreakTime;
		return this;
	}
	...
	public Analysis withAverageRecovery(Double averageRecovery) {
		this.averageRecovery = averageRecovery;
		return this;
	}
	...
	public Analysis withAverageFinalTime(Double averageFinalTime) {
		this.averageFinalTime = averageFinalTime;
		return this;
	}
	...
	public Analysis withRatingAverageFinalTime(Integer ratingAverageFinalTime) {
		this.ratingAverageFinalTime = ratingAverageFinalTime;
		return this;
	}
	...
	public Analysis withAverageFinalBreakTime(Double averageFinalBreakTime) {
		this.averageFinalBreakTime = averageFinalBreakTime;
		return this;
	}
	...
	public Analysis withRatingAverageFinalBreakTime(Integer ratingAverageFinalBreakTime) {
		this.ratingAverageFinalBreakTime = ratingAverageFinalBreakTime;
		return this;
	}
