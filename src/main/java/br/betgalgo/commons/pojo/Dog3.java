...
public class Dog3 implements Serializable {
	 ...
	 */
	public Dog3(Integer dogId, String classPreview, String classPreview3, String classPreviewPanel, Double chanceOfWin,
	...
	public Dog3 withDogId(Integer dogId) {
		this.dogId = dogId;
		return this;
	}
	...
	public Dog3 withClassPreview(String classPreview) {
		this.classPreview = classPreview;
		return this;
	}
	...
	public Dog3 withClassPreview3(String classPreview3) {
		this.classPreview3 = classPreview3;
		return this;
	}
	...
	public Dog3 withClassPreviewPanel(String classPreviewPanel) {
		this.classPreviewPanel = classPreviewPanel;
		return this;
	}
	...
	public Dog3 withChanceOfWin(Double chanceOfWin) {
		this.chanceOfWin = chanceOfWin;
		return this;
	}
	...
	public Dog3 withBestRecordTime(Double bestRecordTime) {
		this.bestRecordTime = bestRecordTime;
		return this;
	}
	...
	public Dog3 withTopSpeed(Integer topSpeed) {
		this.topSpeed = topSpeed;
		return this;
	}
	...
	public Dog3 withTrapNumber(Integer trapNumber) {
		this.trapNumber = trapNumber;
		return this;
	}
	...
	public Dog3 withRaceId(Integer raceId) {
		this.raceId = raceId;
		return this;
	}
	...
	public Dog3 withRaceDate(String raceDate) {
		this.raceDate = raceDate;
		return this;
	}
	...
	public Dog3 withName(String name) {
		this.name = name;
		return this;
	}
	...
	public Dog3 withColor(String color) {
		this.color = color;
		return this;
	}
	...
	public Dog3 withSex(String sex) {
		this.sex = sex;
		return this;
	}
	...
	public Dog3 withBirth(String birth) {
		this.birth = birth;
		return this;
	}
	...
	public Dog3 withWeight(Double weight) {
		this.weight = weight;
		return this;
	}
	...
	public Dog3 withTrainerName(String trainerName) {
		this.trainerName = trainerName;
		return this;
	}
	...
	public Dog3 withLastRaceDate(Integer lastRaceDate) {
		this.lastRaceDate = lastRaceDate;
		return this;
	}
	...
	public Dog3 withAnalysis(Analysis analysis) {
		this.analysis = analysis;
		return this;
	}
	...
	public Dog3 withAnalysis2(Analysis2 analysis2) {
		this.analysis2 = analysis2;
		return this;
	}
	...
	public Dog3 withHistoryRaces(List<HistoryRace> historyRaces) {
		this.historyRaces = historyRaces;
		return this;
	}
